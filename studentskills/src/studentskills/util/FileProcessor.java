...
public final class FileProcessor {
	...
	public FileProcessor(String inputFilePath)
		...
		if (!Files.exists(Paths.get(inputFilePath))) {
			throw new FileNotFoundException("FileProcessor - Invalid input file or input file in incorrect location");
		}
	...
	public String poll() throws IOException {
		MyLogger.writeMessage("FileProcessor - poll - reading next line", DebugLevel.DEBUG);
